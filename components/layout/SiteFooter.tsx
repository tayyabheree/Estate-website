...
export function SiteFooter() {
  return (
    <footer id="contact" className="site-footer bg-navy text-white">
      <div className="brand-line" />

      <div className="container border-b border-white/20 py-12 sm:py-16">
        <div className="grid gap-10 lg:grid-cols-12 lg:items-end">
          <div className="lg:col-span-7">
            <p className="text-[10px] font-bold uppercase tracking-[.17em] text-teal">
              Start a property conversation
            </p>
            <h2 className="mt-3 max-w-[760px] font-serif text-[clamp(2rem,3.2vw,3rem)] font-bold leading-[1.16] tracking-[-.03em]">
      ...
      <div className="container grid gap-10 border-b border-white/20 py-10 md:grid-cols-12">
      ...
      <div className="container flex flex-col gap-2 py-5 text-xs text-white/50 md:flex-row md:items-center md:justify-between">
